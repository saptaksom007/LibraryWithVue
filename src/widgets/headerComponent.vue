<template>
  <header>
    <nav>
      <ul>
        <li @click.prevent="toggleValue(0)">LOGIN</li>
        <li @click.prevent="toggleValue(1)">Register</li>
        <li @click.prevent="toggleValue(2)">Books</li>
        <li @click.prevent="toggleValue(3)">About</li>
      </ul>
    </nav>
  </header>
</template>
